...
urlpatterns = [
    ...
    path('vin/<str:vin_code>/', views.VinInfoPage.as_view(), name='vin_check'),
    path('add-car/', views.AddCarPage.as_view(), name='add_car'),
    path('add-car-model/', views.AddCarModelPage.as_view(), name='add_car_model'),
